...
import com.github.damianmcdonald.currencytrade.data.MongoDBDataAccess
...
class CurrencyTradeApiSpec extends Specification with Specs2RouteTest with MainActors with CurrencyTradeApi with CurrencyTradeBase {
