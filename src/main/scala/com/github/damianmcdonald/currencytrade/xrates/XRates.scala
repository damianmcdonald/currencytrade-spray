...
package com.github.damianmcdonald.currencytrade.xrates

import java.math.{ BigDecimal => JBigDecimal }

import akka.event.slf4j.SLF4JLogging
import com.github.damianmcdonald.currencytrade.Configuration._
import com.github.damianmcdonald.currencytrade.mock.MockCountryData
...
class OpenExchangeRates extends XRates with SLF4JLogging {
   ...
   *
   * @param mock a MockCountryData that contains the currency top check
